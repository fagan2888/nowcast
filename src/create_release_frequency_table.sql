...
CREATE TABLE IF NOT EXISTS release_frequencies(frequency_id SERIAL PRIMARY KEY, frequency INTEGER, frequency_text VARCHAR(15) NOT NULL, frequency_type VARCHAR(10) NOT NULL, UNIQUE frequency_ix (frequency, frequency_type));
