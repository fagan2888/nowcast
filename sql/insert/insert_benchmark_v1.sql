...
VALUES
    ( 1,  5, 4, 0), -- Consumer Sentiment Index (University of Michigan), ussurv0354
    ( 1,  2, 0, 0), -- PMI Non-Manufacturing (ISM), ussurv1044
    ( 1,  1, 0, 0), -- PMI Manufacturing (ISM), ussurv1055
    ...
    ( 1, 13, 5, 5), -- Retail Sales (?)
    ( 1, 44, 5, 5), -- Capacity Utilisation (?)
    ( 1, 43, 5, 5), -- Industrial Production
    ( 1, 17, 5, 5), -- Construction Started Residential
    ( 1, 18, 5, 5), -- Construction Permits
    ( 1, 19, 5, 5), -- Unfiled Orders Durable Goods
    ( 1, 20, 5, 5), -- New Orders Durable Goods
    ( 1, 21, 5, 5), -- Manufacturing Inventories
    ( 1,  8, 5, 5), -- Hours Worked Average Weekly
    ( 1,  9, 5, 0), -- Unemployment
    ( 1, 10, 5, 0), -- Employment non farm payroll
    ( 1, 12, 5, 5), -- Consumer Price Index
    ( 1, 28, 5, 5), -- Personal consumption Expenditures
    ( 1, 40, 6, 6) -- Real Gross Domestic Product
